...
const SignUp = () => {
  ...
  const collectData = async () => {
    ...
    try {
      ...
      console.log(result.data); // Axios parses the JSON response automatically
      ...
      if (result.data.email) {
        ...
        Swal.fire({
          title: "Good job!",
          text: "You are Sign-in SucessFully!",
          icon: "success",
        });
      } else {
        Swal.fire({
          ...
          footer: '<a href="/log-up">Go to login page?</a>',
        });
      }
    } catch (error) {
      console.error(
  ...
  return (
    <div class="relative flex justify-center pt-6 mt-6  items-center flex-col text-gray-700  w-auto  bg-gray-200 shadow-none rounded-xl bg-clip-border">
      ...
      <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
        <div class="flex flex-col gap-6 mb-1">
          ...
          <div class="relative h-11 w-full  bg-zinc-300 min-w-[200px]">
            <input
              value={name}
        ...
        <p class="block mt-4 font-sans text-base antialiased font-normal leading-relaxed text-center text-gray-700">
          ...
          <a href="/log-up" class="font-medium text-gray-900">
            Sign In
          </a>
        </p>
      </form>
...
export default SignUp; // Corrected the export statement
